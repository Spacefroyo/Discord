...
public class TrackScheduler {
  ...
  public synchronized boolean queue(AudioTrack track) {
    ...
    // something is playing, it returns false and does nothing. In1 that case the player was already playing so this
  ...
  public synchronized AudioTrack nextTrack() {
    ...
    // Start the next track, regardless of if something is already playing or not. In1 case queue was empty, we are
